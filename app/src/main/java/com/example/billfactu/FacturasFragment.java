...
public class FacturasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (esJefe) {
            View view = inflater.inflate(R.layout.fragment_facturas_jefe, container, false);
            ...
            uploadButton.setOnClickListener(v -> uploadFactura());

            return view;
        } else {
            View view = inflater.inflate(R.layout.fragment_facturas_no_jefe, container, false);
    ...
    private void obtenerFacturas(String nombreEmpresa) {
        // Mostrar ProgressBar
        progressBar.setVisibility(View.VISIBLE);
        ...
        OkHttpClient client = new OkHttpClient();
        String url = Server.URL + "facturas/";
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        // Navegar a la nueva Activity con las facturas
